...
#----------------Burger_image----------
burger = ImageTk.PhotoImage(Image.open ("taco1.png"))
burger_image=Label(root)
burger_image["image"]=burger
burger_image.place(relx=0.7, rely=0.5,anchor=CENTER)
#----------------Heading Rdonalds----------
label_heading=Label(root,text="Taco Ring", font=("times",40,"bold"),fg="Orange")
...
class parent():
    ...
    def final_amount(dish, add_ons):
        if dish=="taco" and add_ons=="cheese":
            dish_amount["text"]="You need to pay 250 Rupees"
            print("You need to pay 250 Rupees")
        elif dish=="taco" and add_ons=="jalapeno":
            dish_amount["text"]="You need to pay 350 Rupees"
            print("You need to pay 350 Rupees")
        elif dish=="iced_americano" and add_ons=="chocolate":
            dish_amount["text"]="You need to pay 250 Rupees"
            print("You need to pay 250 Rupees")
        elif dish=="iced_americano" and add_ons=="caramel":
            dish_amount["text"]="You need to pay 450 Rupees"
            print("You need to pay 450 Rupees")
